...
from config import DB_USER, DB_PASS, DB_HOST, DB_PORT, DB_NAME, DEBUG
...
if DEBUG:
    ...
    SQLALCHEMY_ASYNC_DATABASE_URL = f"postgresql+asyncpg://{DB_USER}:{DB_PASS}@{DB_HOST}:{DB_PORT}/{DB_NAME}"
