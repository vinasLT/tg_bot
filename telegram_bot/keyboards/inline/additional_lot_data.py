...
def lot_inline_keyboard(lot_id:int, auction_name:str):
    lot_inline = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text=_('📊 Sales statistics'), callback_data=f'sales_statistics_{lot_id}_{auction_name}')
            ],
            [
                InlineKeyboardButton(text=_('ℹ️ About the car'), callback_data=f'about_car_{lot_id}_{auction_name}')
            ],
            [
